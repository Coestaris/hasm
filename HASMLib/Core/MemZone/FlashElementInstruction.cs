...
{
    internal class FlashElementInstruction : FlashElement
    {
        ...
        public FlashElementInstruction(Instruction instruction, List<ObjectReference> arguments, Integer index)
        {
