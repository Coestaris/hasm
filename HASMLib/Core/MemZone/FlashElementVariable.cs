...
{
    public class FlashElementVariable : FlashElement
    {
        public Integer Index { get; private set; }
        public TypeReference VariableType { get; private set; }

        public override FlashElementType Type => FlashElementType.Variable;
        ...
        public FlashElementVariable(Integer index, TypeReference type)
        {
            Index = index;
            VariableType = type;
        }
